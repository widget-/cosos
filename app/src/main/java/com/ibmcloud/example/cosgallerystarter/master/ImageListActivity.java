...
import com.ibmcloud.example.cosgallerystarter.detail.ImageDetailActivity;
...
public class ImageListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new ImageListRecyclerViewAdapter(this, DummyContent.ITEMS, mTwoPane));
    }
